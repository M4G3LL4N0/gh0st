import { Conversation, Message, Attachment, Agent, ToolEvent, UsageRecord, EncryptedContinuation, PrivacyState, ExportPackage } from "@gh0st/core";
...
export interface MessageStorage {
    ...
    search(conversationId: string, query: string, options?: {
        limit?: number;
    }): Promise<Message[]>;
}
...
export declare const STORAGE_NAME = "gh0st-vault";
